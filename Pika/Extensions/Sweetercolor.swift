...
extension NSColor {
  ...
  class func black() -> NSColor {
    return NSColor(r: 0, g: 0, b: 0, a: 1)
  }
  ...
  class func white() -> NSColor {
    return NSColor(r: 1, g: 1, b: 1, a: 1)
  }
  ...
  var fullContrastColor: NSColor {
    ...
    return 0.5 < delta ? NSColor.black() : NSColor.white()
  }
  ...
  var overlayBlack: NSColor {
    return self.overlay(with: NSColor.black())
  }
  ...
  var overlayWhite: NSColor {
    return self.overlay(with: NSColor.white())
  }
