...
//     */
//    var HSLA: [CGFloat] {
//        guard let hslColor = usingColorSpace(NSColorSpace.deviceRGB) else {
//            return [0, 0, 0, 0]
//        }
//
//        let H: CGFloat = hslColor.hueComponent
//        let S: CGFloat = hslColor.saturationComponent
//        let L: CGFloat = hslColor.lightnessComponent
//        let A: CGFloat = hslColor.alphaComponent
//
//        return [H, S, L, A]
//    }
//
...
//     - returns: An array of four CGFloat numbers representing HSBA respectively. Ranges: H[0,360], S[0,100], B[0,100], A[0,1]
//     */
//    var HSLA_8Bit: [CGFloat] {
//        let HSBA = self.HSLA
//        return [round(HSLA[0] * 360), round(HSLA[1] * 100), round(HSLA[2] * 100), HSLA[3]]
//    }
//
//    /**
//     Get the 8 bit hue, saturation, and brightness values.
...
//     - returns: An array of three CGFloat numbers representing HSB respectively. Ranges: H[0,360], S[0,100], B[0,100]
//     */
//    var HSL_8Bit: [CGFloat] {
//        let HSBA = self.HSLA
//        return [round(HSLA[0] * 360), round(HSLA[1] * 100), round(HSLA[2] * 100)]
//    }
//
//    /**
...
//        let HSL = HSL_8Bit
//        let hue = Int(HSL[0])
//        let saturation = Int(HSL[1])
//        let lightness = Int(HSL[2])
